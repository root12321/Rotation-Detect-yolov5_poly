...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/data/dataset/dataset_download/val/jueyuanzi_fangzhenchui/', help='file/dir/URL/glob, 0 for webcam')#/data/dataset/dataset_download/val/img_640
