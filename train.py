"""Train a YOLOv5 model on a custom datasetinvalid authentication data
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    hyp['cls'] *= nc / 10. * 3. / nl  # scale to classes and layers
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if RANK in [-1, 0]:
            ...
            if (not noval or final_epoch) and epoch%20==1:  # Calculate mAP
